...
Sometimes you want randomness that is *unpredictable*, but still
*repeatable*, and derived from a *known*, *human memorable* start point.
...
security-relevant, you want `random.SystemRandom`; if you just want random
bytes, you want `os.urandom`.
...
However, the Python standard library's random number *implementation* doesn't
